...
dataroot1 = "/kaggle/input/animecharacterfaces/animeface-character-dataset"
dataroot2 = "/kaggle/input/celeba-redux/celebA_redux"
...
concat = torch.utils.data.ConcatDataset([dataset1, dataset2])


# In[6]:


dataloader = torch.utils.data.DataLoader(concat,
